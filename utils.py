...
Guidelines:
- Each question should probe a different dimension: technical/functional skills, situational judgment, and cultural/behavioural fit.
- Questions must be specific to the "{job_title}" role -- avoid generic questions that could apply to any job.
